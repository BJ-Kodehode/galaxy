...
const kidsQuiz = [
  ...
  },
  {
    ...
    options: ["Stein", "Gass og ild", "Metall"],
    answer: 1,
  ...
  {
    question: "Hva bruker astronauter for å reise til verdensrommet?",
    options: [],
    answer: null,
    explanation: "Astronauter bruker en romrakett for å reise til verdensrommet."
  }
];
